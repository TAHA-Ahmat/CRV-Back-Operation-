...
| FIX_ENGINS_GET_CRV | Backend+Frontend / Fix | FAIT ET BRANCHÉ | MERGEABLE AVEC RÉSERVES | [Rapport](../../Front/docs/audit/FIX_ENGINS_GET_CRV_RAPPORT.md) | [Briefing](../../Front/docs/audit/BRIEFING_GPT_FIX_ENGINS_GET_CRV.md) | ⚠️ ZONE ROUGE crv.controller.js. GET /crv/:id retournait crv.materielUtilise (vide) au lieu d'AffectationEnginVol. Fix: query + mapping. 5 fichiers, +37/-8. |
| REVIEW_MERGE_AND_SOUMISSION_PREP | Gouvernance / Analyse | FAIT ET BRANCHÉ | N/A (analyse) | [Rapport](../../Front/docs/audit/REVIEW_MERGE_AND_SOUMISSION_PREP_RAPPORT.md) | [Briefing](../../Front/docs/audit/BRIEFING_GPT_REVIEW_MERGE_AND_SOUMISSION_PREP.md) | Review 2 branches (front MERGEABLE, back MERGEABLE AVEC RÉSERVES). Analyse renommage Validation→Soumission : COSMÉTIQUE pure, ~5 fichiers frontend, 0 backend. |
| SAFE_MERGE_AND_SOUMISSION | Gouvernance + COSMÉTIQUE | FAIT ET BRANCHÉ | MERGEABLE | [Rapport](../../Front/docs/audit/SAFE_MERGE_AND_SOUMISSION_RAPPORT.md) | [Briefing](../../Front/docs/audit/BRIEFING_GPT_SAFE_MERGE_AND_SOUMISSION.md) | Merge front (0 zone rouge) + merge back (zone rouge reviewée OK) + rename "Validation"→"Soumission" étape 7 wizard. 7 fichiers front, 0 backend. Build + UI vérifiés. |
| P0_CLOSE_CRV_FINAL_BLOCKERS | PRODUIT / Fix P0 | FAIT ET BRANCHÉ | MERGEABLE AVEC RÉSERVES | [Rapport](../../Front/docs/audit/P0_CLOSE_CRV_FINAL_BLOCKERS_RAPPORT.md) | [Briefing](../../Front/docs/audit/BRIEFING_GPT_P0_CLOSE_CRV_FINAL_BLOCKERS.md) | ⚠️ ZONE ROUGE crv.controller.js (2 lignes). Fix responsableVol (fallback user), fix absence charge (modèle+calcul+UI), séparation soumission/validation. Cycle E2E prouvé: TERMINÉ→VALIDÉ→VERROUILLÉ+PDF. |
| CRV_PRODUCT_ARCHITECTURE | Documentation / Architecture | FAIT ET BRANCHÉ | N/A (documentation) | [Architecture Produit](../../docs/architecture/CRV_PRODUCT_ARCHITECTURE.md) | — | 5 livrables : cadre de décision, architecture 3 couches (production/gouvernance/consultation), plan d'action P1-P6, UX cible par profil, angles morts. SLA explicitement hors scope. 0 fichiers source. |
| CRV_STABILIZATION_ALIGNMENT | Documentation / Gouvernance | FAIT ET BRANCHÉ | N/A (documentation) | [Stabilisation](../../docs/architecture/CRV_STABILIZATION_ALIGNMENT.md) | — | Audit croisé code/doctrine/cible. 4 écarts identifiés : label TERMINÉ (faible alignement), responsableVol sans UI (faible), archivage timing (moyen), historique rejets (moyen). Plan STAB-1→STAB-4 priorisé. 0 fichiers source. |
| CRV_STAB_EXECUTION | HYGIÈNE + PRODUIT | FAIT ET BRANCHÉ | MERGEABLE | [Rapport](../../docs/architecture/CRV_STABILIZATION_EXECUTION_REPORT.md) | [Non-régression](../../docs/architecture/CRV_STABILIZATION_NON_REGRESSION_PROOF.md) | STAB-1: label Terminé→Soumis (6 fichiers). STAB-2 v2: isResponsable dans personnel embarqué (Option C). STAB-3: doctrine archivage. STAB-4: fix rejet motif + historiqueRejets. Zone rouge: AUCUNE. |
| CRV_STAB2_FINAL | PRODUIT / Stabilisation | FAIT ET BRANCHÉ | MERGEABLE | [Rapport](../../docs/architecture/CRV_STAB2_RESPONSABLE_VOL_REPORT.md) | [Non-régression](../../docs/architecture/CRV_STAB2_NON_REGRESSION_PROOF.md) | Fermeture STAB-2 : sélecteur String (non persisté) → flag isResponsable dans personnelAffecte (persisté, atomique, rechargé). 4 fichiers front, 1 back. Zone rouge: AUCUNE. |
| CRV_SUPERVISOR_WORKBENCH | PRODUIT / Superviseur | FAIT ET BRANCHÉ | MERGEABLE | [Rapport](../../docs/architecture/CRV_SUPERVISOR_WORKBENCH_REPORT.md) | [Non-régression](../../docs/architecture/CRV_SUPERVISOR_NON_REGRESSION_PROOF.md) | Fiche lecture CRV superviseur : 9 sections + bouton PDF. 1 fichier front. 0 backend. Zone rouge: AUCUNE. |
| CRV_SUPERVISOR_REFINEMENT | PRODUIT / Superviseur | FAIT ET BRANCHÉ | MERGEABLE | [Rapport](../../docs/architecture/CRV_SUPERVISOR_REFINEMENT_REPORT.md) | [Non-régression](../../docs/architecture/CRV_SUPERVISOR_REFINEMENT_NON_REGRESSION_PROOF.md) | Liste enrichie (badges rejet/événement/responsable). Résumé décisionnel 6 champs. Alerte rejet en haut de fiche. +60/-9 lignes. 1 fichier front. 0 backend. Zone rouge: AUCUNE. |
